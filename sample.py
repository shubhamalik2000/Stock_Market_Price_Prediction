...
with open("model_pickle",'rb', "https://github.com/shubhamalik2000/Stock_Market_Price_Prediction") as f:
    model = pickle.load(f)


def load_data():
    data = pd.read_csv("finaldata.csv", "https://github.com/shubhamalik2000/Stock_Market_Price_Prediction")
