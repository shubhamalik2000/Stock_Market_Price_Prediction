...
with open("https://github.com/shubhamalik2000/Stock_Market_Price_Prediction/model_pickle",'rb') as f:
    model = pickle.load(f)


def load_data():
    data = pd.read_csv("https://github.com/shubhamalik2000/Stock_Market_Price_Prediction/finaldata.csv")
